    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ExternalLoginCallback()
        {
            ...
            if (user == null)
            {
                ...
                user = await _users.AutoProvisionUser(provider, providerUserId, claims.ToList());
            }
        ...
        //private async AppUser AutoProvisionUser(string provider, string providerUserId, IEnumerable<Claim> claims)
        //{
